...
│   │                             + router composition (routes.rs)   hq-mod-routes
│   │                             + event versioning (event_kind.rs) hq-mod-events
│   ├── gt-module-mcp                MCP tool registry (schemars)       hq-mod-mcp
│   ├── gt-module-migrate            per-module SQL loader (sqlx)       hq-mod-migrate
